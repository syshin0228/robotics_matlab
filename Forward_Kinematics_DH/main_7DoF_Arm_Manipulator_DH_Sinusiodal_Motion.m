...
for i = 1:1:Hz*Rep
    ...
    th4 = A4*sin(w4*t) * deg2rad;
    th5 = A5*sin(w5*t) * deg2rad;
    th6 = A6*sin(w6*t) * deg2rad;
    th7 = A7*sin(w7*t) * deg2rad;
    ...
    th4_out(i) = th4 * rad2deg;
    th5_out(i) = th5 * rad2deg;
    th6_out(i) = th6 * rad2deg;
    th7_out(i) = th7 * rad2deg;
