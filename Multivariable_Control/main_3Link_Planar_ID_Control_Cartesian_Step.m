...
% Simulate Forward dynamics of 3 Link Planar Manipulator 
...
for i = 1:1:length(time)
    ...
    a_x(3) = ddalpha_d -Kd(3)*dP(3) + Kp(3)*(alpha_d - alpha);
...
for i = 1:step:length(time)
    ...
    plot3(P_d(1), P_d(2), 0, 'bo','linewidth',2)
    line([P_d(1) Ori_d(1)],[P_d(2) Ori_d(2)],[0 0], 'color', 'b', 'linewidth', 2)
