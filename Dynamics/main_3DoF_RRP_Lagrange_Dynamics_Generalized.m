...
% Euler-Lagrange Equations of Motion of 3DoF RRP Manipulator
% Generalized form
% Parameterization
syms m1 m2 m3 I1 I2 I3 L1 L2 L1c L2c g;      % Mass, Moment of Inertia, Link lengths, Gravity acc
...
T23 = DH(0, d3, alpha3, a3);

% DH parameter Link 1 CoM
a1 = 0; alpha1 = pi/2; d1 = L1c;
T01c = DH(q1, d1, alpha1, a1);

% DH parameter Link 2 CoM
a2 = 0; alpha2 = -pi/2; d2 = 0;
T12c = DH(q2-pi/2, d2, alpha2, a2);

% DH parameter Link 3 CoM
a3 = 0; alpha3 = 0; d3c = L2c+q3;
T23c = DH(0, d3c, alpha3, a3);
