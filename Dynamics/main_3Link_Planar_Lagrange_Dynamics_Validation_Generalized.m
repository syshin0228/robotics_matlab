...
% Get desired torque using given desired motion with Inverse Dynamics in
% generalized form
...
for i = 1:1:length(time)
    ...
    % Inverse Dynamics of generalized form
...
xlabel('Time [Sec]')
legend([h10, h11, h12],'Desired torque J1 Generalized', 'Desired torque J2 Generalized', 'Desired torque J3 Generalized')
set(gca,'fontsize',13)
...
ylabel('Angle [Deg]')
legend([h1, h2, h3, h4, h5, h6],'Desired traj J1', 'Desired traj J2', 'Desired traj J3', 'Output traj from GFD J1', 'Output traj from GFD J2', 'Output traj from GFD J3')
set(gca,'fontsize',13)
subplot(3,1,2)
